...
> 📷 需要参考图: 1 | ✏️ 需要填写变量: 37 | ✅ 可直接使用: 35

## Index

| ID | Title | Desc | Input |
|----|-------|------|-------|
| 400 | 多风格签名选择海报 | 你是一个高端签名设计系统 + 风格人格视觉系统。 任务： 仅基于用户输入的「姓名」，生成一张「... | ✏️ 输入你的昵称, 姓名 |
| 387 | Netflix 首页主视觉 UI | Create a Netflix homepage UI featuring a main h... | ✅ |
| 336 | 个人网页视觉设计 | 原文未公开，案例目标是生成一张高完成度的个人主页视觉设计图。 | ✅ |
| 335 | 朋友圈截图生成 | 原文未公开，重点展示 GPT-Image2 在高仿社交截图与中文排版场景中的能力。 | ✅ |
| 330 | 月下美女直播画面 | 生成一张直播间的图片，直播间氛围是月下美女跳舞的画面，直播间有很多人评论 | ✅ |
| 308 | 抖音直播截图画面 | [中文] 9:16 的图片比例，生成一张抖音直播的截图，里面是 xxx 在直播，xxx 手里拿... | ✏️ English, 中文 |
| 289 | 直播界面设计图 | [中文] 生成特朗普和金正恩在抖音直播间打PK的截图 [English] Generate a... | ✏️ English, 中文 |
| 288 | 抖音美女直播间界面设计 | [中文] 生成抖音直播间界面，内容是一个美女在直播 [English] Generate a ... | ✏️ English, 中文 |
| 287 | 不知火舞的小红书主页 | [中文] 生成不知火舞的小红书主页截图 [English] Generate a screen... | ✏️ English, 中文 |
| 285 | 真实动漫画面快照 | [中文] 向我展示这张附带的图像作为一部真实动漫的快照 [English] Show me t... | ✏️ English, 中文 |
| 282 | 温柔治愈系二次元手机截图 | [中文] 生成一张竖版手机截图风格的图片，整体比例接近 9:16。画面中心偏上是一位真人 co... | ✏️ English, 中文 |
| 280 | 封面排版设计图 | [中文] 以涂鸦速写风表现【一个厉害的AI builder】，整体呈现快速勾勒、自由变形、即兴... | ✏️ English, an awesome AI b, theme/subject... |
| 269 | 拒绝盲目催婚的暖心视频号截图 | [中文] 生成视频号内容截图，主题：中老年不要盲目催婚，iPhone尺寸 [English] ... | ✏️ English, 中文 |
| 261 | 智能视频生成器暗黑界面设计 | [中文] 渲染一个专业的IOS APP首页UI图，该主题为AI Video Generator... | ✏️ English, 中文 |
| 260 | 社媒界面截图 | [中文] 生成抖音内容截图，主题：跟上AI浪潮9.9包教会，iPhone尺寸 [English... | ✏️ English, 中文 |
| 259 | 精致女孩背后的网贷真相 | [中文] 生成小红书内容截图，主题：精致女孩背后都有网贷，iPhone尺寸 [English]... | ✏️ English, 中文 |
| 258 | 快手直播离婚预告手机截图 | [中文] 生成快手内容截图：主题：直播离婚预告，iPhone尺寸 [English] Gene... | ✏️ English, 中文 |
| 257 | 抖音汉服美女直播带货截图 | [中文] 生成一个抖音直播的截图里面是一个穿着中国传统服饰的美女在直播卖货 [English]... | ✏️ English, 中文 |
| 256 | 抖音直播间的绝美女主播 | [中文] 生成一个抖音直播的截图 里面是一个美女在直播 [English] Generate ... | ✏️ English, 中文 |
| 255 | 瑜伽裤女主播展示身材曲线 | [中文] 手机竖屏界面，短视频直播平台风格，一位年轻亚洲女主播在家中直播带货，主播穿着贴身瑜伽... | ✏️ English, 中文 |
| 249 | 美女举牌感谢大哥打赏大火箭 | [中文] 生成一个抖音直播的截图 ，一个美女在直播，美女手里拿着牌子，上面写着：谢谢行者大哥的... | ✏️ English, 中文 |
| 243 | 定制专属风格界面设计系统 | [中文] 用xx风格帮我生成一套UI设计系统，包含网页、移动端、卡片、控件、按钮 以及其它 [... | ✏️ English, 中文 |
| 239 | 刘亦菲抖音直播畅聊中 | [中文] 9:16 的图片比例，生成一张抖音直播的截图，里面是 刘亦菲 在直播，刘亦菲 手里拿... | ✏️ English, 中文 |
| 227 | 哔哩哔哩户晨风直播截图 | [中文] 9:16 的图片，生成一张哔哩哔哩直播的截图，里面是 户晨风在直播，户晨风表情开心，... | ✏️ English, 中文 |
| 213 | 金瓶梅古风开放世界游戏截图 | [中文] 帮我生成一个以《金瓶梅》为主题的古代 ARPG MMO 开放世界游戏的截图 [Eng... | ✏️ English, 中文 |
| 209 | 神话三国枪战世界 | [中文] 模仿《无畏契约》的风格，生成一个三国神话的 FPS 游戏 [English] Imi... | ✏️ English, 中文 |
| 207 | 黑神话潘金莲绝美游戏封面 | [中文] 生成一张黑神话·潘金莲的游戏介绍画面，人物十分的迷人 [English] Gener... | ✏️ English, 中文 |
| 200 | 热度爆表的美女内衣直播间 | [中文] 生成一个抖音直播的截图 里面是一个美女在直播，在卖丝袜和内衣，她的在线人数是9999... | ✏️ English, 中文 |
| 197 | 英雄联盟特朗普中路对决哈梅内伊 | [中文] 帮我生成一张特朗普对战哈梅内伊在英雄联盟中路对线的截图。 [English] Hel... | ✏️ English, 中文 |
| 188 | 暗黑极简头像网站视觉设计 | [中文] 用 ABCD（a black cover design) 的风格，为 图你太美 设计... | ✏️ English, 中文 |
| 177 | 吉利银河暗黑中控界面 | [中文] 帮我生成一个吉利银河m9的中控界面，尺寸为21:9，暗色系 [English] He... | ✏️ English, 中文 |
| 164 | 特朗普太空直播间破千万 | [中文] 一张9:16竖屏的抖音直播截图，太空直播风格。特朗普穿着NASA风格的白色宇航服，头... | ✏️ English, 中文 |
| 163 | 诗仙李白月下直播起舞 | [中文] 李白在抖音直播月下起舞 [English] Li Bai dancing under... | ✏️ English, 中文 |
| 161 | 应用界面样机图 | {   "type": "video game screenshot mockup",   "... | ✅ |
| 159 | 界面交互设计图 | {   "type": "e-commerce livestream UI mockup", ... | ✏️ "透气速干", "弹力舒适", |
| 158 | 界面交互设计图 | {   "type": "e-commerce live stream interface m... | ✏️ "透气速干", "弹力舒适",, "7天无理由退货", "运费险 |
| 156 | 应用界面样机图 | {   "type": "mobile live-streaming e-commerce i... | ✏️ "带货总榜第3名", "人气榜, "7天无理由退货", "运费险 |
| 152 | 直播界面设计图 | {   "type": "e-commerce livestream screenshot m... | ✏️ "强大推理", "代码神器",, "超强推理能力", "代码能力 |
| 149 | 直播界面设计图 | {   "type": "mobile livestream e-commerce inter... | ✅ |
| 148 | 综合应用场景图 | A {argument name="platform" default="Taobao"} p... | ✅ |
| 146 | 综合应用场景图 | A {argument name="platform" default="Taobao"} p... | ✅ |
| 145 | 综合应用场景图 | A {argument name="platform" default="Taobao"} p... | ✅ |
| 133 | 界面交互设计图 | {   "type": "brand identity system presentation... | ✅ |
| 131 | 界面交互设计图 | {   "type": "UI/UX landing page mockup",   "the... | ✏️ "总播放量", "互动率", , "10M+", "43%",  |
| 111 | 视频封面界面图 | A YouTube thumbnail-style collage for a {argume... | ✅ |
| 110 | 视频封面界面图 | Thumbnail for a YouTube unboxing video, a video... | ✅ |
| 109 | 综合应用场景图 | {argument name="subject" default="A beautiful i... | ✅ |
| 108 | 综合应用场景图 | {argument name="subject" default="A beautiful i... | ✅ |
| 107 | 应用界面样机图 | {"type": "YouTube desktop dark mode UI mockup",... | ✅ |
| 104 | 界面交互设计图 | {   "type": "YouTube livestream UI",   "top_nav... | ✅ |
| 103 | 视频封面界面图 | {argument name="pianist" default="Vladimir Horo... | ✅ |
| 96 | 主题海报版式设计 | {   "type": "VTuber stream thumbnail",   "chara... | ✏️ "pink", "yellow |
| 95 | 品牌视觉识别图 | {   "type": "anime-style livestream thumbnail",... | ✅ |
| 94 | 绘画艺术风格图 | {   "type": "VTuber stream thumbnail",   "theme... | ✅ |
| 93 | 插画艺术风格创作 | {   "type": "VTuber stream thumbnail",   "style... | ✅ |
| 92 | 视频封面界面图 | An anime-style YouTube stream thumbnail featuri... | ✅ |
| 91 | 游戏界面截图 | A highly detailed, realistic first-person video... | ✅ |
| 90 | 信息图可视化设计 | GPT-Image-2 prompt: please automatically genera... | ✏️ Typography Syst, Automatic Deriv, Visual Quality... |
| 82 | 信息图可视化设计 | {   "type": "scientific optical setup diagram",... | ✅ |
| 57 | 界面交互设计图 | {   "type": "mobile social media app UI mockup"... | ✏️ verified badge |
| 49 | 直播界面设计图 | A 9:16 aspect ratio image, generating a screens... | ✅ |
| 48 | 直播界面设计图 | A 9:16 aspect ratio image, generating a screens... | ✅ |
| 42 | 写实摄影风格图 | Express {argument name="subject" default="a pow... | ✅ |
| 21 | 直播界面设计图 | {   "type": "live stream UI mockup",   "subject... | ✅ |
| 7 | 应用界面样机图 | 生成一张竖版手机截图风格的图片，整体比例接近 9:16。画面中心偏上是一位真人 coser，扮... | 📷 参考图片 |
| 4 | 老干妈风味 | 特朗普在抖音直播间卖老干妈，手里举着「老干妈风味」新品，背景还是 SpaceX 那种科技感，左... | ✅ |
| 2 | 社媒界面截图 | 画一张 X 的内容截图，深色模式，@OpenAI 蓝勾认证账号发推。  正文的中文内容：  今... | ✅ |
| 1 | 信息图可视化设计 | Vertical 9:16 isometric cutaway infographic "城市... | ✅ |
| 503 | AURAE新银行记账App首页 | Design a polished mobile finance app UI mockup ... | ✅ |
| 504 | HELIX OPS运维数据仪表盘 | Create a high-end desktop SaaS analytics dashbo... | ✅ |
| 505 | LUMEN UI设计系统组件展板 | Generate a clean design system overview board f... | ✅ |
| 506 | NOVA VAULT Web3钱包深色界面 | Design a premium mobile web3 wallet app mockup ... | ✅ |
| 507 | VITA LOOP健康追踪App日报页 | Create a refined mobile health tracking app scr... | ✅ |
...
**封面排版设计图**
Input: ✏️ 需要填写 → [English], [an awesome AI builder], [theme/subject], [中文]
...
**界面交互设计图**
Input: ✏️ 需要填写 → ["透气速干", "弹力舒适", "运动百搭"], ["7天无理由退货", "运费险"]
...
**应用界面样机图**
Input: ✏️ 需要填写 → ["带货总榜第3名", "人气榜"], ["7天无理由退货", "运费险"]
...
**直播界面设计图**
Input: ✏️ 需要填写 → ["强大推理", "代码神器", "安全可靠", "极速响应"], ["超强推理能力", "代码能力巅峰", "复杂任务轻松搞定"]
...
**界面交互设计图**
Input: ✏️ 需要填写 → ["总播放量", "互动率", "转化咨询", "执行周期"], ["10M+", "43%", "28,000+", "3,200+"]
...
**主题海报版式设计**
Input: ✏️ 需要填写 → ["pink", "yellow", "purple"]
